...
def scrape_articles_local():
    """Local version for manual testing without Modal dependencies"""
    import requests
    import xml.etree.ElementTree as ET
    ...
    supabase_url = os.environ.get("SUPABASE_URL", "https://keajnbcsqgyfgyikvbca.supabase.co")
    supabase_key = os.environ.get("SUPABASE_SERVICE_KEY", "sb_publishable_tUM51WsQtzlmiiLABjCnBw_N3HeE0ay")
